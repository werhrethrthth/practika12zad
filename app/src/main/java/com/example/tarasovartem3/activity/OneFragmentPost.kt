...
import com.example.tarasovartem3.databinding.ActivityOneFragmentPostBinding
import com.example.tarasovartem3.until.StringArg
        ...
        postId?.let { id ->
            ...
            viewModel.selectedPost.observe(viewLifecycleOwner) { post ->
                ...
                binding.Video.setOnClickListener {
                    val url = "https://www.youtube.com/watch?v=VPwQ7OAGe0k&t=3s&ab_channel=%D0%A5%D0%B0%D0%B9%D0%BB%D0%B0%D0%B9%D1%82%D1%8B%D0%9F%D0%B8%D1%80%D0%B0%D1%82%D0%B0"
